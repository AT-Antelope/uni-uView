				...
				<view class="page-view">
					...
					<view class="class-item">
						...
						<view class="item-container">
							<navigator v-for="(goods, goodsIndex) in goodsList" :key="goods.id" :url="'/pages/goods/goods-details?id=' + goods.id" class="thumb-box">
...
.u-tab-item-active::before {
	content: '';
	position: absolute;
	border-left: 4px solid $u-main-color;
	height: 32rpx;
	left: 0;
	top: 39rpx;
}
